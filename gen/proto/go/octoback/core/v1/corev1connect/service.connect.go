...
import (
	...
	v1 "github.com/kiliandbigblue/octoback/gen/proto/go/octoback/core/v1"
)
...
const (
	...
	ServiceGetGroceryListProcedure = "/octoback.core.v1.Service/GetGroceryList"
	// ServiceCreateGroceryListProcedure is the fully-qualified name of the Service's CreateGroceryList
	// RPC.
	ServiceCreateGroceryListProcedure = "/octoback.core.v1.Service/CreateGroceryList"
	// ServiceUpdateGroceryListProcedure is the fully-qualified name of the Service's UpdateGroceryList
	// RPC.
	ServiceUpdateGroceryListProcedure = "/octoback.core.v1.Service/UpdateGroceryList"
	// ServiceListGroceryListsProcedure is the fully-qualified name of the Service's ListGroceryLists
	// RPC.
	ServiceListGroceryListsProcedure = "/octoback.core.v1.Service/ListGroceryLists"
	// ServiceDeleteGroceryListProcedure is the fully-qualified name of the Service's DeleteGroceryList
	// RPC.
	ServiceDeleteGroceryListProcedure = "/octoback.core.v1.Service/DeleteGroceryList"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	serviceServiceDescriptor                 = v1.File_octoback_core_v1_service_proto.Services().ByName("Service")
...
// ServiceClient is a client for the octoback.core.v1.Service service.
...
// NewServiceClient constructs a client for the octoback.core.v1.Service service. By default, it
...
// GetGroceryList calls octoback.core.v1.Service.GetGroceryList.
...
// CreateGroceryList calls octoback.core.v1.Service.CreateGroceryList.
...
// UpdateGroceryList calls octoback.core.v1.Service.UpdateGroceryList.
...
// ListGroceryLists calls octoback.core.v1.Service.ListGroceryLists.
...
// DeleteGroceryList calls octoback.core.v1.Service.DeleteGroceryList.
...
// ServiceHandler is an implementation of the octoback.core.v1.Service service.
...
func NewServiceHandler(svc ServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/octoback.core.v1.Service/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedServiceHandler) GetGroceryList(context.Context, *connect.Request[v1.GetGroceryListRequest]) (*connect.Response[v1.GetGroceryListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("octoback.core.v1.Service.GetGroceryList is not implemented"))
}
...
func (UnimplementedServiceHandler) CreateGroceryList(context.Context, *connect.Request[v1.CreateGroceryListRequest]) (*connect.Response[v1.CreateGroceryListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("octoback.core.v1.Service.CreateGroceryList is not implemented"))
}
...
func (UnimplementedServiceHandler) UpdateGroceryList(context.Context, *connect.Request[v1.UpdateGroceryListRequest]) (*connect.Response[v1.UpdateGroceryListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("octoback.core.v1.Service.UpdateGroceryList is not implemented"))
}
...
func (UnimplementedServiceHandler) ListGroceryLists(context.Context, *connect.Request[v1.ListGroceryListsRequest]) (*connect.Response[v1.ListGroceryListsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("octoback.core.v1.Service.ListGroceryLists is not implemented"))
}
...
func (UnimplementedServiceHandler) DeleteGroceryList(context.Context, *connect.Request[v1.DeleteGroceryListRequest]) (*connect.Response[v1.DeleteGroceryListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("octoback.core.v1.Service.DeleteGroceryList is not implemented"))
}
